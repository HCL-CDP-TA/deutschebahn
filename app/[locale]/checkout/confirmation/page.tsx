              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {customerData?.dateOfBirth ? new Date(customerData.dateOfBirth).toLocaleDateString() : "-"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {customerData
                        ? `${customerData.title ? customerData.title + " " : ""}${customerData.firstName} ${
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{customerData?.username || "-"}</span>
                  </div>
                  <div className="flex justify-between">
